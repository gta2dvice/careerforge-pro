...
export const pricingPlans = [
  {
    ...
    price: '₹0',
    period: 'forever',
    description: 'Perfect for getting started with resume building and basic AI optimization.',
    features: [
      '1 Resume',
      'ATS score analysis',
      'Basic templates',
  ...
  },
  {
    ...
    price: '₹299',
    period: 'per month',
    description: 'Unlimited access to all features for serious job seekers.',
    features: [
